    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <p>Some description of the games we have on our website.</p>
                    <p>Maybe something about the recruitment process or such</p>
                    <p>Adding extra info maybe about how to best become recruited from this website</p>
                </div>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-4 text-center">
                    ...
                    <h3>Counter Strike
                        <small>Global Offensive</small>
                    </h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="http://placehold.it/750x450" alt="">
                    <h3>League Of Legends
                        <small>Currently in Season?</small>
                    </h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="http://placehold.it/750x450" alt="">
